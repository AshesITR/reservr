...
Overall, noting that that $F_\infty((-\infty, \infty]) = 1$, we have motivated the likelihood contribution $F_\theta((m, v]) \cdot 1(m < v)$ for a censored, untruncated observation in \eqref{eq:cml-likelihood-nw}.
...
\end{align*}
Overall, we arrive at the (conditional) log-likelihood contribution $\log f_\theta(y) - \log F_\theta((l, u])$ for a noncensored, truncated observation in \eqref{eq:cml-likelihood-nw}.
