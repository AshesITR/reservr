...
\begin{align} \label{eq:blended}
    \mathop{\mathrm{Blended}}(\mathcal{F}, \mathcal{G}; \kappa, \varepsilon) & := \{ \mathop{\mathrm{Blended}}(P, Q ; p, \kappa, \varepsilon) \mid P \in \mathcal{F}, Q \in
    \mathcal{G}, p \in [0, 1]^2, \lVert p\rVert_1 = 1 \}.
\end{align}
